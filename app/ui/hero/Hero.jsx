...
export default function HeroSection() {
  return (
    ...
    >  
      <section className='md:w-1/2 flex flex-col gap-4 md:shadow-sm  z-10'>
      
          <h1 className='text-3xl text-foreground font-bold md:text-5xl md:mx-8 shadow-sm'> 
            Welcome to <span className='bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-blue-700'>Kodetrix</span>
          </h1>
      ...
      <section className='md:w-1/2 flex mt-4 md:mt-0 md:shadow-sm'>
        <Image 
          src="/hero.jpeg" 
          alt="hero-image" 
          width={1000} 
