...
export default function HeroSection() {
  ...
  return (
    ...
    >  
      <section className='md:mx-12 md:w-1/2 flex flex-col gap-4 md:shadow-sm  z-10 animate__animated animate__fadeInRight animate__delay-1s'>
        ...
        <p className='md:h-48 text-lg md:mx-8 mt-2 font-semibold text-gray-600 leading-tight md:leading-normal'>
      ...
      <section className='md:mx-12 md:w-1/2 flex mt-4 md:mt-0 md:shadow-sm animate__animated animate__fadeInDown animate__delay-2s'>
        <Image 
          src="/hero.jpeg" 
          alt="hero-image" 
          width={800} 
          height={700}
          className='rounded-lg  md:min-h-[72vh]  h-[50%] md:h-auto'
        />
      </section>   
    </div>
   );
