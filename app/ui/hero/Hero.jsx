...
export default function HeroSection() {
  return (
    ...
    >
    ...
    </div><div class="mt-5 max-w-3xl text-center mx-auto">
      ...
      </div><div class="mt-8 gap-3 flex justify-center">
      ...
      </div><div class="mt-5 flex justify-center items-center gap-x-1 sm:gap-x-3">
