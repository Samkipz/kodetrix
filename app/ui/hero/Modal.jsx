...
const QuoteRequestModal = ({ 
  ...
  return (
    <div 
      className="size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto bg-black bg-opacity-50"
      onClick={onClose}
      role="dialog"
      tabIndex="-1"
    >
      <div 
        className="mt-7 sm:max-w-lg sm:w-full m-3 sm:mx-auto"
