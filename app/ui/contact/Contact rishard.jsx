  ...
  return (
    ...
    >
      <div className="container flex flex-col md:flex-row justify-between items-center xl:max-w-6xl mx-auto">
        ...
        {/* Right Image Section */}
        <div className="mt-8 md:mt-0 flex items-center justify-center md:justify-end w-full md:w-1/2 animate__animated animate__fadeInDown animate__delay-2s p-1">
          {/* Form */}
          <form>
