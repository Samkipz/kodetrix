...
export default function Footer() {
  return (
    <footer className="px-4 w-full md:px-12">
      <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="flex w-full flex-col lg:gap-8">

          <div className="flex flex-col w-full items-center justify-center text-center py-4">
          ...
          <div className="mt-8 grid gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
