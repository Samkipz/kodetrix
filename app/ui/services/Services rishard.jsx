...
const Services = () => {
  ...
  return (
    <section id="services" ref={sectionRef} className="flex flex-col md:justify-center md:items-center xl:justify-start py-2 w-full  scroll-mt-20 scroll-smooth min-h-[90vh]">
            <div className="container xl:max-w-6xl mx-auto text-center lg:text-left">
              <h2 className="text-4xl font-bold text-gray-900 leading-snug mb-5">
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-blue-700 lg:ml-2 lg:text-left text-center">Services</span>
              </h2>
              <p className="text-gray-500 leading-relaxed font-light text-xl pb-2 text-center md:text-left mb-4">
                Learn more about the services Kodetix offers.
              </p>
            </div>
      <div className="container xl:max-w-6xl mx-auto border border-gray-300 rounded-lg p-2">
        {items.map((item) => (
          <AccordionItem
            key={item.key}
